...
document.addEvent('domready', function(){
  ...
  $('translations-iframe').set('html', '<iframe src="http://www.indezinez.com/api/recenthistory/translations.php?l='+chrome.i18n.getMessage("@@ui_locale")+'" frameborder="0" scrolling="no"></iframe>');
