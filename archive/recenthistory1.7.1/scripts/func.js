...
function getLangText(){
  ...
  switch(lang){
    ...
    case "ru": return ["Последние посещенные страницы", "Недавно закрытые вкладки", "Вся история", "Стирать историю при старте", "Размер иконки", "Язык", "(Очищает только историю расширения, а не фактическую историю)", "Стереть историю", "Сохранить", "Да", "нет", "ширина", "поиск", "Порядок", "Наиболее посещаемый"];
...
window.addEvent('domready', function(){
  ...
  if($('insert')){
    ...
    var footer = '<span id="showhistoryblock"><a id="rhpabout" href="#"></a><a id="rhpoptions" href="#"></a><a id="rhpmanager" href="#"></a><a id="rhpclear" href="#"></a><span id="rhpclearconfirm"><a id="rhpclearyes" href="#"></a><a id="rhpclearno" href="#"></a></span><a id="showhistorylink" href="#">'+text[2]+'</a></span>';
