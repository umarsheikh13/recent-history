...
window.addEvent('domready', function(){
  ...
  if($('insert')){
    ...
    var footer = '<span id="showhistoryblock"><a id="rhpabout" href="#"></a><a id="rhpoptions" href="#"></a><a id="rhpmanager" href="#"></a><a id="rhpclear" href="#"></a><a id="showhistorylink" href="#">'+text[2]+'</a></span>';
