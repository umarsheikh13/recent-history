...
function getLangText(){
  ...
  switch(lang){
    ...
    case "ru": return ["Последние посещенные страницы", "Недавно закрытые вкладки", "Вся история", "Стирать историю при старте", "Размер иконки", "Язык", "(Очищает только историю расширения, а не фактическую историю)", "Стереть историю", "Сохранить", "Да", "нет", "ширина"];
