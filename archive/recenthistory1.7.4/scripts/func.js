...
function getLangText(){
  ...
  switch(lang){
    case "en": return ["Recent History", "Recently Closed Tabs", "Show All History", "Clear History on Startup", "Icon Size", "Language", "(This will only clear the Recent History extension's cache not your actual history)", "Clear Recent History", "Save", "Yes", "No", "Width", "Search", "Order", "Most Visited", "Time"]; break;
    case "fr": return ["Historique Recent", "Onglets récemment fermés", "Voir tout l'historique", "Supprimer l'historique à l'ouverture", "Taille de l'icône", "Langue", "(Cela ne supprimera que votre historique récent de votre extension et non pas votre historique)", "Supprimer l'historique récent", "Sauvegarder", "Oui", "Non", "Largeur", "Recherche", "Ordre", "Les plus visités", "Temps"]; break;
    case "de": return ["Neuester Verlauf", "Kürzlich geschlossene Tabs", "Zeige gesamten Verlauf", "Verlauf beim Start löschen", "Symbolgröße", "Sprache", "(Es wird nur der Zwischenspeicher der Erweiterung Neuester Verlauf gelöscht, nicht der richtige Verlauf)", "Neuesten Verlauf löschen", "Speichern", "Ja", "Nein", "Breite", "Suche", "Bestellen", "Oft besucht", "Zeit"]; break;
    case "es": return ["La historia reciente", "Pestañas cerradas recientemente", "Mostrar todos los Historia", "Borrar historial de inicio de", "Tamaño de los iconos", "Idioma", "(Esto sólo será evidente, no caché la extensión Historia reciente de su historia real)", "La historia reciente abierto", "Salvar", "Sí", "No", "Anchura", "Búsqueda", "Orden", "Más visitado", "Tiempo"]; break;
    case "cs": return ["Nedávná historie", "Nedávno zavřené karty", "Ukaž celou historii", "Vymaž historii při startu", "Velikost ikon", "Jazyk", "(Tímto smažete jen vyrovnávací paměť rozšíření Nedávná historie, nikoliv svou skutečnou historii)", "Vymaž nedávnou historii", "Uložit", "Ano", "Ne", "šířka", "Hledat", "Pořadí", "Nejnavštěvovanější", "Čas"]; break;
    case "ru": return ["Последние посещенные страницы", "Недавно закрытые вкладки", "Вся история", "Стирать историю при старте", "Размер иконки", "Язык", "(Очищает только историю расширения, а не фактическую историю)", "Стереть историю", "Сохранить", "Да", "нет", "ширина", "поиск", "Порядок", "Наиболее посещаемые", "Время"];
    case "ar": return ["تاريخ التصفح الحديث", "التبويبات المغلقة حديثا", "عرض كل التاريخ", "تنظيف تاريخ التصفح عند بدأ التشغيل", "حجم الأيقونة", "اللغة", "(هذا الخيار سينظف فقط تاريخ التصفح الحديث الخاص بالإضافة وليس تاريخ التصفح الفعلي الخاص بك)", "تنظيف تاريخ التصفح الحديث", "حفظ", "نعم", "لا", "العرض", "البحث", "رتب", "الأكثر زيارة", "مرة"]; break;
    case "pt": return ["Histórico Recente", "Tabs Fechadas Recentemente", "Mostrar todo o Histórico", "Limpara Histórico ao Iniciar", "Tamanho do Ícone", "Língua", "(Isso limpará somente o Histórico Recente da extenção, não seu histórico atual)", "Limpar o Histórico Recente", "Salvar", "Sim", "Não", "Largura", "Buscar", "Ordenar", "Mais Vistos", "Tempo"]; break;
    default: return ["Recent History", "Recently Closed Tabs", "Show All History", "Clear History on Startup", "Icon Size", "Language", "(This will only clear the Recent History extension's cache not your actual history)", "Clear Recent History", "Save", "Yes", "No", "Width", "Search", "Order", "Most Visited", "Time"];
  }
...
function optionsLangText(){
  ...
  $$('label[for=rhtime]').set('text', optionslang[15]);
...
window.addEvent('domready', function(){
  ...
  if($('options')){
    ...
    $('save').addEvent('click', function(){
      ...
      var nine = localStorage['rh-time'] = $('rhtime').getSelected().getProperty('value');
