...
window.addEvent('domready', function(){
  ...
  if($('options')){
    ...
    $('save').addEvent('click', function(){
      ...
      if(localStorage['rh-itemsno'] == $('itemsno').getSelected().getProperty('value') && localStorage['rct-itemsno'] == $('rctitemsno').getSelected().getProperty('value') && localStorage['clearsu'] == $('clearsu').getSelected().getProperty('value')){
